...
import BY.views as views

urlpatterns = [
    path('', views.homepage, name="homepage"),
    path('userhome/', views.user_homepage, name="userhomepage"),
    path('staffhome/', views.staff_homepage, name="staffhomepage"),
    path('user/', views.user_log_sign_page, name="userloginpage"),
    path('reviews',views.reviewpage,name="reviewspage"),
    ...
    path('logout/', views.logoutuser, name="logout"),  # Corrected the name to "logout"
    ...
    path('staff/panel/edit-room', views.edit_room, name="editroom"),  # Added name for edit-room
    path('staff/panel/add-new-room', views.add_new_room, name="addroom"),
    path('staff/panel/edit-room/edit', views.edit_room),  # No need for a name here if it's the same view
    path('staff/panel/view-room', views.view_room, name="viewroom"),  # Added name for view-room
